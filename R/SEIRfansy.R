...
#' @param data (Mandatory) input :If the model is Multinomial then the data matrix 
#' should contain 3 columns namely Confirmed,Recovered and Death, while if the model 
#' is Poisson or Binomial, then the data should contain only one column namely Confirmed. 
#' Please see that the names of the colums are maintained.
...
#' paramters which should consist of the initial values of the time varying beta , 
#' proportion of testing for the different periods.
#' @param niter = 1e5 (default)  No of iteration for the MCMC metropolis hasting 
#' algorithm.
...
#' be used. There are three options available namely Multinomial, Poisson and Binomial.
...
#' on the lockdowm measures imposed by the goverment. So this is a vector 
...
#' which is used for the initializing the parameters. The parameters are 
#' described below:
#'            \itemize{
...
#'                 is not so severe as they consists of mostly asymptomatic people. 
...
#'                 of simplicity.}
#'                 \item{"D_d"}{= 17.8 (default) Mean days till death for positive 
#'                 individuals.}
#'                 \item{"D_e"}{= 5.2 (default) Incubation period .}
#'                 \item{"Dr"}{= 17.8 (default) Mean days till recovery for positive 
#'                 individuals.}
